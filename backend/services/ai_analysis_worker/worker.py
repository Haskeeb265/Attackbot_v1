...
class WorkerConfig(BaseServiceConfig):
    service_name: str = "ai-analysis-worker"
...
@app.task(name="ai_analysis_worker_task", bind=True, max_retries=3)
def ai_analysis_worker_task(self, message: dict) -> None:  # type: ignore[misc]
