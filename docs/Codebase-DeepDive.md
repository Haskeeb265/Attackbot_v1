...
The schema is built incrementally across 7 Alembic migrations:

| Migration | Milestone | Tables |
|-----------|-----------|--------|
| 001 | M1 | `programs`, `scans` |
| 002 | M2 | `program_scopes`, `program_policies` |
| 003 | M3 | `scan_stages`, `assets`, `endpoints` |
...
*Generated by manual codebase analysis of the M4_ReadTheRoom branch (commit `8f35f9b`).*
